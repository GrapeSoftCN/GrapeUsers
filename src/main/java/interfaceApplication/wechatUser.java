...
public class wechatUser {
	...
	public String insertOpenId(String info) {
		...
		if (object != null) {
			try {
				...
				String userinfo = appsProxy.proxyCall("/GrapeWechat/Wechat/getUserInfo/s:" + openid, null, "")
						.toString();
	...
	public String pageby(int ids, int pageSize, String info) {
		...
		if (objects != null) {
			try {
				openIdBind().and();
				for (Iterator localIterator = objects.keySet().iterator(); localIterator.hasNext();) {
